# Guia do Scrum Master — Zé da Mercearia

**SM:** João Victor ([@JV-L0pes](https://github.com/JV-L0pes)) · ErrorSquad-ABP · GAP 2026/1
...
| Item | Situação |
|------|----------|
| Sprint ativa | **Sprint 1** — Fundação + estoque básico |
| Planning 1 | ✅ [ata](../ceremonies/sprint_01/sprint_planning.md) |
...
| Dev | Carlos, Caio, Felipe, Leo |

Detalhes: [equipe.md](equipe.md) · [RACI](raci_equipe.md)
...
Arquitetura, mockups, pseudocódigo, testes, CI — time dev. Priorização — Arthur (PO).

---

## Links

- [Product Backlog](../product_backlog/product_backlog_ze_mercearia.md)
- [Sprint Backlog](../sprint_backlog/sprint_backlog_ze_mercearia.md)
- [Issues Sprint 1](https://github.com/ErrorSquad-ABP/FATEC-JCR-3DSM-GAP-2026-1/issues?q=label%3Asprint-1)
